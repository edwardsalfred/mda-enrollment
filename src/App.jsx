...
const STEPS = [
  ...
  { id: 32, section: "Company Portal", title: "You're all set → Done", narration: "When you see You're All Set, your device is managed and both checks are complete. Tap Done. Now wait a few minutes — the device connects to mdamobile and your apps begin to download.", image: IMG.cpAllSet, hx: 50, hy: 91, htext: "Tap Done", wait: 3000, waitLabel: "Connecting to mdamobile…", doneLabel: "Done →" },

  // ---------- SECTION 6: Passcode & Home ----------
  { id: 33, section: "Passcode", title: "Passcode Requirement → Change Now", narration: "A Passcode Requirement prompt appears saying you must set an iPhone unlock passcode. Tap Change Now. If you're not prompted right away, wait about one minute for it to appear.", image: IMG.pcRequire, hx: 68, hy: 57, htext: "Tap Change Now" },
  { id: 34, section: "Passcode", title: "New Passcode → Continue", narration: "On the New Passcode prompt, enter a passcode with 6 or more digits, then tap Continue.", image: IMG.pcNew, hx: 50, hy: 41, htext: "Enter passcode, then Continue", sensitive: true },
  { id: 35, section: "Passcode", title: "Re-enter passcode → Set Passcode", narration: "You'll be asked to re-enter the same passcode to confirm it. Type it again, then tap Set Passcode.", image: IMG.pcReenter, hx: 50, hy: 38, htext: "Re-enter passcode, then Set Passcode", sensitive: true },

  // ---------- SECTION 7: App Configuration ----------
  { id: 36, section: "Apps", title: "Open the Outlook app", narration: "On the Home Screen, find and tap the Outlook app to set up your email.", image: IMG.olHome, hx: 62, hy: 15, htext: "Tap Outlook" },
  { id: 37, section: "Apps", title: "Welcome to Outlook → Add Account", narration: "On the Welcome to Outlook screen, tap Add Account.", image: IMG.olWelcome, hx: 50, hy: 82, htext: "Tap Add Account" },
  { id: 38, section: "Apps", title: "Add Work Account", narration: "Outlook finds your MD Anderson account. Tap Add Work Account.", image: IMG.olAccountFound, hx: 50, hy: 88, htext: "Tap Add Work Account", sensitive: true },
  { id: 39, section: "Apps", title: "Enable Notifications → Turn On", narration: "On the Enable Notifications prompt, tap Turn On.", image: IMG.olEnableNotif, hx: 67, hy: 57, htext: "Tap Turn On" },
  { id: 40, section: "Apps", title: "Allow notifications", narration: "On the iOS notifications prompt, tap Allow. Your inbox will load, then you can swipe up to close Outlook.", image: IMG.olAllowNotif, hx: 67, hy: 58, htext: "Tap Allow" },
  { id: 41, section: "Apps", title: "Open the Edge app", narration: "On the Home Screen, find and tap the Edge app.", image: IMG.edgeHome, hx: 70, hy: 68, htext: "Tap Edge" },
  { id: 42, section: "Apps", title: "Set as default browser", narration: "On the Make Microsoft Edge Your Default Browser screen, tap Set as default browser.", image: IMG.edgeMakeDefault, hx: 50, hy: 87, htext: "Tap Set as default browser" },
  { id: 43, section: "Apps", title: "Tap Default Browser App", narration: "In the Edge settings screen that opens, tap Default Browser App (it currently shows Safari).", image: IMG.edgeSettings, hx: 68, hy: 51, htext: "Tap Default Browser App" },
  { id: 44, section: "Apps", title: "Select Edge", narration: "On the Default Browser App screen, tap Edge so it shows a checkmark. Then close the app by swiping up.", image: IMG.edgePicker, hx: 50, hy: 20, htext: "Tap Edge" },
  { id: 45, section: "Apps", title: "Open the MS Defender app", narration: "On the Home Screen, find and tap the MS Defender app.", image: IMG.defHome, hx: 62, hy: 60, htext: "Tap MS Defender" },
  { id: 46, section: "Apps", title: "Allow Defender notifications", narration: "Microsoft Defender opens. On the notifications prompt, tap Allow so you're notified of threats and security updates.", image: IMG.defAllow, hx: 67, hy: 58, htext: "Tap Allow" },
  { id: 47, section: "Apps", title: "Open Settings", narration: "Now activate the Employee Caller ID. On the Home Screen, tap the Settings app.", image: IMG.cidHome, hx: 90, hy: 78, htext: "Tap Settings" },
  { id: 48, section: "Apps", title: "Scroll down and tap Apps", narration: "Scroll down in Settings until you see Apps, then tap it.", image: IMG.cidSettings, hx: 50, hy: 84, htext: "Tap Apps" },
  { id: 49, section: "Apps", title: "Tap Call Blocking & Identification", narration: "Open Phone, then tap Call Blocking and Identification.", image: IMG.cidPhone, hx: 50, hy: 48, htext: "Tap Call Blocking & Identification" },
  { id: 50, section: "Apps", title: "Toggle on the Employee app", narration: "Under Call Identification, toggle on the Employee app.", image: IMG.cidToggleOff, hx: 82, hy: 35, htext: "Toggle on Employee" },
  { id: 51, section: "Apps", title: "Employee Caller ID is on", narration: "The Employee toggle now shows green. Next, open the Employee app to refresh the Caller ID directory.", image: IMG.cidToggleOn, hx: null, hy: null, htext: "", doneLabel: "Continue →" },
  { id: 52, section: "Apps", title: "Open the Employee app", narration: "Go back to the Home Screen and tap the Employee app.", image: IMG.empHome, hx: 61, hy: 25, htext: "Tap Employee" },
  { id: 53, section: "Apps", title: "Sign in prompt → OK", narration: "A Sign In prompt explains your organization needs to manage this app. Tap OK.", image: IMG.empSignIn, hx: 50, hy: 60, htext: "Tap OK" },
  { id: 54, section: "Apps", title: "Pick your account", narration: "On the Pick Account screen, tap your MD Anderson account.", image: IMG.empPick, hx: 50, hy: 19, htext: "Tap your account", sensitive: true },
  { id: 55, section: "Apps", title: "Enter password → Sign in", narration: "Enter your MD Anderson password, then tap Sign in.", image: IMG.empPwd, hx: 81, hy: 48, htext: "Enter password, then Sign in", sensitive: true },
  { id: 56, section: "Apps", title: "Support team message → OK", narration: "A message confirms your organization's support team is helping protect work data in this app. Tap OK.", image: IMG.empOrgOk, hx: 50, hy: 60, htext: "Tap OK" },
  { id: 57, section: "Apps", title: "Tap Caller ID", narration: "The Employee app opens. Scroll down and tap Caller ID.", image: IMG.empAppHome, hx: 17, hy: 80, htext: "Tap Caller ID" },
  { id: 58, section: "Apps", title: "Tap Refresh Caller ID", narration: "On the Caller ID screen, tap the red Refresh Caller ID button.", image: IMG.empRefresh, hx: 50, hy: 57, htext: "Tap Refresh Caller ID" },
  { id: 59, section: "Apps", title: "Caller ID list updated → OK", narration: "The Caller ID directory refresh is complete. Tap OK.", image: IMG.empUpdated, hx: 50, hy: 57, htext: "Tap OK" },

  // ---------- SECTION 8: Lookout & Secure DNS ----------
  { id: 60, section: "Lookout", title: "Open the Lookout Work app", narration: "On the Home Screen, tap the Lookout Work app.", image: IMG.lkHome, hx: 23, hy: 18, htext: "Tap Lookout Work" },
  { id: 61, section: "Lookout", title: "Let's get started → Continue", narration: "Lookout explains it needs permission for notifications, Secure DNS, and location. Tap Continue.", image: IMG.lkStart, hx: 50, hy: 90, htext: "Tap Continue" },
  { id: 62, section: "Lookout", title: "Allow While Using App", narration: "On the location prompt, tap Allow While Using App.", image: IMG.lkLocation, hx: 50, hy: 82, htext: "Tap Allow While Using App" },
  { id: 63, section: "Lookout", title: "Setup Secure DNS → Go to Settings", narration: "Lookout shows the Secure DNS setup steps. Tap Go to Settings.", image: IMG.lkDnsSetup, hx: 50, hy: 75, htext: "Tap Go to Settings" },
  { id: 64, section: "Lookout", title: "Tap General", narration: "In Settings, tap General.", image: IMG.lkSettings, hx: 50, hy: 54, htext: "Tap General" },
  { id: 65, section: "Lookout", title: "Tap VPN & Device Management", narration: "Scroll down and tap VPN and Device Management.", image: IMG.lkGeneral, hx: 50, hy: 75, htext: "Tap VPN & Device Management" },
  { id: 66, section: "Lookout", title: "Tap DNS", narration: "Under Restrictions and Proxies, tap DNS.", image: IMG.lkVpnMgmt, hx: 50, hy: 31, htext: "Tap DNS" },
  { id: 67, section: "Lookout", title: "Select Lookout Work", narration: "On the DNS screen, tap Lookout Work to make it your DNS proxy.", image: IMG.lkDnsPick, hx: 50, hy: 36, htext: "Tap Lookout Work" },
  { id: 68, section: "Lookout", title: "Lookout Secure DNS is active", narration: "Lookout Work now shows a checkmark. Secure DNS is active and your enrollment is complete.", image: IMG.lkDnsDone, hx: null, hy: null, htext: "", doneLabel: "Finish enrollment →" },
];
