...
const STEPS = [
  ...
  { id: 34, section: "Company Portal", title: "You're all set → Done", narration: "When you see You're All Set, your device is managed and both checks are complete. Tap Done. Now wait a few minutes — the device connects to mdamobile and your apps begin to download.", image: IMG.cpAllSet, hx: 50, hy: 91, htext: "Tap Done", wait: 3000, waitLabel: "Connecting to mdamobile…", doneLabel: "Done →" },
